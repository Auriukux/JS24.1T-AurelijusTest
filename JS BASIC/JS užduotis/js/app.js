...
const atsargos = [
    {
        ...
        "knygos": [
            ...
            { "title": "Webo technologijos", "autorius": "Neal Stephenson", "ISBN": "IT-12346", "leidybos_metai": 2022, "puslapiu": 300, "kiekis": 7, "kaina": 42 },
    ...
    },
    {
        ...
        "knygos": [
            ...
            { "title": "Neuromantas", "autorius": "William Gibson", "ISBN": "F-00002", "leidybos_metai": 1984, "puslapiu": 271, "kiekis": 15, "kaina": 10 },
    ...
    },
    {
        ...
        "knygos": [
            ...
            { "title": "Pirmasis žaidėjas", "autorius": "Ernest Cline", "ISBN": "SF-00003", "leidybos_metai": 2011, "puslapiu": 374, "kiekis": 13, "kaina": 17 },
            { "title": "Autostopu per galaktiką", "autorius": "Douglas Adams", "ISBN": "SF-00004", "leidybos_metai": 1979, "puslapiu": 215, "kiekis": 14, "kaina": 18 },
            { "title": "Sniego katastrofa", "autorius": "Henrik Strieberg", "ISBN": "SF-00005", "leidybos_metai": 1992, "puslapiu": 470, "kiekis": 9, "kaina": 28 }
        ]
    },
];
...
function apskaiciuotiAtsargas(atsargos) {
    ...
    for (let kategorija of atsargos) {
        ...
        console.log(`\nKategorija: ${kategorija.kategorijos}`);
...
console.log("\nFiltruotos knygos pagal kategoriją, pavadinimą ir puslapių:");
